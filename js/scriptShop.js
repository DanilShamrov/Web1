...
function generateCards(){
    var cards=[["Ремонт двигателя", "100 000₽", "assets/engine.svg"], ["Коробка передач", "50 000₽", "assets/gearbox.svg"], ["Лобовое стекло", "25 000₽", "assets/windshield.svg"], ["Шины зимние", "10 000₽", "assets/tires.svg"], ["Шины летние", "10 000₽", "assets/tires.svg"], ["Тормозные колодки", "20 000₽", "assets/brakes.svg"], ["Фары передние", "5 000₽", "assets/light.svg"], ["Машинное масло", "1 000₽", "assets/oil.svg"]]
...
function createCard(name, price, src){
    ...
    btn.onclick=()=>{addItem(name, price, img.src, selectedButton)}
